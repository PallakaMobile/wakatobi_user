package ps.salam.wakatobi.support.imageslider.Transformers;
 ...
 *
 * BaseTransformer implement {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link android.support.v4.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link ps.salam.wakatobi.support.imageslider.Animations.BaseAnimationInterface}
 * work.
 *
