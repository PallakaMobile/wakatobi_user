package ps.salam.wakatobi.support.fab.rfabgroup;
...
import ps.salam.wakatobi.support.fab.RapidFloatingActionButton;
import ps.salam.wakatobi.support.fab.listener.OnRapidFloatingButtonGroupListener;
...
public class RapidFloatingActionButtonGroup extends FrameLayout implements View.OnClickListener {
    ...
    private void addRFABToMemory(@NonNull RapidFloatingActionButton rfab) {
        ...
        if (RapidFloatingActionButton.IDENTIFICATION_CODE_NONE.equals(identificationCode)) {
            throw new RuntimeException("RFAB[" + rfab + "]'Response IDENTIFICATION CODE can not be IDENTIFICATION_CODE_NONE if you used RapidFloatingActionButtonGroup");
        }
