package ps.salam.wakatobi.support.imageslider;
...
import ps.salam.wakatobi.support.imageslider.Animations.BaseAnimationInterface;
import ps.salam.wakatobi.support.imageslider.Indicators.PagerIndicator;
import ps.salam.wakatobi.support.imageslider.SliderTypes.BaseSliderView;
import ps.salam.wakatobi.support.imageslider.Transformers.BaseTransformer;
import ps.salam.wakatobi.support.imageslider.Transformers.DefaultTransformer;
import ps.salam.wakatobi.support.imageslider.Tricks.FixedSpeedScroller;
import ps.salam.wakatobi.support.imageslider.Tricks.InfinitePagerAdapter;
import ps.salam.wakatobi.support.imageslider.Tricks.InfiniteViewPager;
import ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx;
...
/**
 * SliderLayout is compound layout. This is combined with {@link ps.salam.wakatobi.support.imageslider.Indicators.PagerIndicator}
 * and {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx} .
 * <p/>
...
public class SliderLayout extends RelativeLayout {
    ...
    /**
     * {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx} indicator.
     */
    private PagerIndicator mIndicator;


    /**
     * A timer and a TimerTask using to cycle the {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx}.
     */
    private Timer mCycleTimer;
    private TimerTask mCycleTask;

    /**
     * For resuming the cycle, after user touch or click the {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx}.
     */
    private Timer mResumingTimer;
    private TimerTask mResumingTask;

    /**
     * If {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx} is Cycling
     */
    private boolean mCycling;

    /**
     * Determine if auto recover after user touch the {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx}
     */
    ...
    /**
     * {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx} transformer time span.
     */
    ...
    /**
     * Visibility of {@link ps.salam.wakatobi.support.imageslider.Indicators.PagerIndicator}
     */
    private PagerIndicator.IndicatorVisibility mIndicatorVisibility = PagerIndicator.IndicatorVisibility.Visible;

    /**
     * {@link ps.salam.wakatobi.support.imageslider.Tricks.ViewPagerEx} 'Response transformer
     */
    private BaseTransformer mViewPagerTransformer;

    /**
     * @see ps.salam.wakatobi.support.imageslider.Animations.BaseAnimationInterface
     */
    private BaseAnimationInterface mCustomAnimation;

    /**
     * {@link ps.salam.wakatobi.support.imageslider.Indicators.PagerIndicator} shape, rect or oval.
     */
    ...
    public SliderLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mContext = context;
        LayoutInflater.from(context).inflate(R.layout.image_slider_render_type_text, this, true);
        ...
        int visibility = attributes.getInt(R.styleable.SliderLayout_indicator_visibility, 1);
        ...
        mProgressDialog = (ProgressBar) findViewById(R.id.loading_bar);
        mLinearLayout = (LinearLayout) findViewById(R.id.description_layout);
        mIndicator = (PagerIndicator) findViewById(R.id.default_center_bottom_indicator);

        //set visibility gone for fix double layout
     ...
     * {@link ps.salam.wakatobi.support.imageslider.Animations.BaseAnimationInterface},
     * and you can see a example in {@link ps.salam.wakatobi.support.imageslider.Animations.DescriptionAnimation}
     *
     * @param animation
     */
    ...
    /**
     * get the {@link ps.salam.wakatobi.support.imageslider.Indicators.PagerIndicator} instance.
    ...
    /**
     * remove  the slider at the position. Notice: It'Response a not perfect method, a very small bug still exists.
     */
    ...
    /**
     * remove all the sliders. Notice: It'Response a not perfect method, a very small bug still exists.
     */
    public void removeAllSliders() {
        if (getRealAdapter() != null) {
            ...
            //bug: when remove adapter'Response all the sliders.some caching slider still alive.
