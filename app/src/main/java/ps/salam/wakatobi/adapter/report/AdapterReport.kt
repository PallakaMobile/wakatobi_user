...
import ps.salam.wakatobi.ui.fragment.report.PReport
...
class AdapterReport(val listReport: ArrayList<DataDetailReport.Response>, val mPresenter: PReport) : RecyclerView.Adapter<AdapterReport.MyHolder>() {
    ...
    class MyHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        fun bindListReport(listReport: DataDetailReport.Response, mPresenter: PReport) {
