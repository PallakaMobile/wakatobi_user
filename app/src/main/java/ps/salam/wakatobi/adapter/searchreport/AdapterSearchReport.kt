...
import ps.salam.wakatobi.ui.searchreport.PSearchReport
...
class AdapterSearchReport(val listReport: ArrayList<DataDetailReport.Response>, val mPresenter: PSearchReport) : RecyclerView.Adapter<AdapterSearchReport.MyHolder>() {
    ...
    class MyHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        fun bindListReport(listReport: DataDetailReport.Response, mPresenter: PSearchReport) {
